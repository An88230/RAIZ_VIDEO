...
export interface JobPaths {
  ...
  realHttpSenderReadinessPath: string;
  shortVideoMakerSentRequestPath: string;
  ...
  googleDriveExportPlanPath: string;
  n8nWorkflowPlanPath: string;
}
...
export function getJobPaths(jobId: string, options: PersistenceOptions = {}): JobPaths {
  ...
  return {
    ...
    realHttpSenderReadinessPath: resolve(jobDir, "real-http-sender-readiness.json"),
    ...
    googleDriveExportPlanPath: resolve(jobDir, "google-drive-export.plan.json"),
    n8nWorkflowPlanPath: resolve(jobDir, "n8n-workflow.plan.json")
  };
}
